module github.com/pulumi/pulumi-go-provider/openapi

// We keep this in a seperate module because we don't want to require all users to
// download OpenAPI parsing libraries.
