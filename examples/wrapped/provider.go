...
// 	name string,
// 	version string,
// 	options *pprovider.ProviderOptions,
// ) (pprovider.ResourceProviderServer, error) {
// 	// This is a placeholder for the actual implementation of the provider.
// 	// In a real-world scenario, this would be replaced with the actual provider logic.
// 	return nil, nil
// }
...
// copied from:
// https://github.com/pulumi/pulumi-provider-boilerplate/blob/10130357137e4b239c62a9f20a38872204e3f83b/provider/pkg/provider/provider.go
...
var _ pulumirpc.ResourceProviderServer = (*xyzProvider)(nil)
...
func (p *xyzProvider) Create(ctx context.Context, req *pulumirpc.CreateRequest) (*pulumirpc.CreateResponse, error) {
	...
	if n < 8 {
		p.host.Log(ctx, diag.Warning, urn, fmt.Sprintf("length %d is too small, using 8", n))
		n = 8
	}
