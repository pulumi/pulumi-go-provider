module github.com/iwahbe/pulumi-go-provider/examples/serverless
...
require (
	...
	github.com/iwahbe/pulumi-go-provider v0.2.0
	github.com/pulumi/pulumi-aws-apigateway/sdk v0.0.6
